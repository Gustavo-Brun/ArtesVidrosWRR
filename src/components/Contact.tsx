...
export const Contact = () => {
  return (
    <section id="contato" className=" m-10 flex flex-col md:flex-row w-4/5 mx-auto py-10 ">
        <aside className="md:w-1/2 bg-color-gray text-white p-5 rounded-t-3xl md:rounded-t-none md:rounded-l-3xl space-y-4">
        ...
        <aside className="md:w-1/2 bg-white p-5 md:rounded-r-3xl rounded-b-3xl md:rounded-t-none">
